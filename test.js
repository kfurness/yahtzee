...
var cases = [
  ...
  {category: 'Fivez', dice: [1,4,3,4,5], expected: 5},
  {category: 'Fivez', dice: [1,5,3,4,5], expected: 10},
  {category: 'Sixes', dice: [1,5,3,4,5], expected: 0},
  {category: 'Sixes', dice: [6,5,6,6,5], expected: 18},
  {category: 'ThreeKindOMG', dice: [1,4,3,3,3], expected: 18},
  {category: 'ThreeKindOMG', dice: [1,4,2,5,3], expected: 0},
  {category: 'ThreeKindOMG', dice: [1,1,1,5,3], expected: 18},
  {category: 'Fourokind', dice: [1,1,1,1,3], expected: 4},
  {category: 'Fourokind', dice: [4,4,4,4,3], expected: 16},
  {category: 'Fourokind', dice: [1,5,5,5,5], expected: 20},
  {category: 'Fourokind', dice: [1,5,2,5,5], expected: 0},
