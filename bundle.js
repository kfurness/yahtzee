...
module.exports = {
  ...
  findTheIndexOfAMatch: function findTheIndexOfAMatch(obj, num) {
  ...
  removeDuplicated: function removeDuplicated(arr) {
    return arr.filter(function (c, i, a) {
      return a.indexOf(c) == i;
    });
  },

  objectMaker: function objectMaker(dice) {
    var diceObj = {};
  ...
  samezies: function samezies(arr) {
